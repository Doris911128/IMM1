                ...
                if isLoading {
                    ...
                    ScrollView(showsIndicators: false) {
                        LazyVStack {
                            ...
                            { dish in
                                NavigationLink(destination: Recipe_IP_View(U_ID: "", Dis_ID: dish.Dis_ID, isFavorited: true)) {
                                    RecipeBlock(imageName: dish.D_image, title: dish.Dis_Name, U_ID: "", Dis_ID: dish.Dis_ID, isFavorited: true)
                                }
                                .padding(.bottom, -70)
                            }
                        }
